...
<template>
    <aside :class="store.getToggleState ? 'lg:w-60' : '-translate-x-full lg:w-20 lg:translate-x-0'" class="flex flex-col justify-between bg-white dark:bg-darken h-full row-span-2 px-2 py-2 z-50 shadow-lg 
      ...
      transition-all ease-in-out">
        <div class="flex ml-2 items-center border-b border-slate-300 dark:border-colorBorder pb-2 text-center mb-2">
            ...
            <span :class="store.getToggleState ? 'lg:block' : 'lg:hidden'"
